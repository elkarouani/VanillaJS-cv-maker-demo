...
export default class Test {
  ...
  _message: string;
  // error existance state
  _errors_exists: boolean;
  // store instance
  _main_store: Store;
  ...
  TestSetName(name_input: any): void {
  ...
  TestSetEmail(email_input: any): void {
  ...
  TestSetWebsite(website_input: any): void {
  ...
  TestSetPhone(phone_input: any): void {
  ...
  TestSetAddress(address_input: any): void {
  ...
  TestAddExperience(
    experience_place_input: any,
    experience_date_input: any,
    experience_center_input: any,
    experience_add_action: any
  ): void {
    ...
    this._errors_exists = (
      this._main_store.client.experiences[0].place != "test" &&
  ...
  TestRemoveExperience(experience_remove_action: any): void {
  ...
  TestAddFormation(
    formation_type_input: any,
    formation_date_input: any,
    formation_place_input: any,
    formation_add_action: any
  ): void {
    ...
    this._errors_exists = (
      this._main_store.client.formations[0].type != "test" &&
  ...
  TestRemoveFormation(formation_remove_action: any): void {
  ...
  TestAddSkill(skill_input: any): void {
  ...
  TestAddHobbie(hobbie_input: any): void {
  ...
  TestRemoveskill(skill_remove_action: any): void {
  ...
  TestRemoveHobbie(hobbie_remove_action: any): void {
